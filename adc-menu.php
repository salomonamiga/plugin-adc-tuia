...
class ADC_Programs_Menu_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            ...
            <select class="widefat" id="<?php echo esc_attr($this->get_field_id('language')); ?>"
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('menu_text')); ?>"
                name="<?php echo esc_attr($this->get_field_name('menu_text')); ?>" type="text"
                value="<?php echo esc_attr($menu_text); ?>">
        </p>
        <p>
            <input class="checkbox" type="checkbox" <?php checked($show_count, '1'); ?>
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_class')); ?>"
                ...
                value="<?php echo esc_attr($custom_class); ?>" placeholder="adc-dropdown-menu">
        </p>
        <?php
    }
