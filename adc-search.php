...
class ADC_Search_Widget extends WP_Widget
{
    ...
    public function form($instance)
    {
        ...
        <p>
            <input class="checkbox" type="checkbox" <?php checked($show_suggestions, '1'); ?>
                id="<?php echo esc_attr($this->get_field_id('show_suggestions')); ?>"
                name="<?php echo esc_attr($this->get_field_name('show_suggestions')); ?>" value="1">
        ...
        <p>
            ...
            <input class="widefat" id="<?php echo esc_attr($this->get_field_id('custom_class')); ?>"
                ...
                value="<?php echo esc_attr($custom_class); ?>" placeholder="adc-search-form">
        </p>
        <?php
    }
